...
namespace Tufan.Common.Localization
{
    public abstract class LocalizerBase<TResource>
    {
        ...
        protected virtual LocalizedString GetString(string name, params object[] arguments)
        {
            ...
            if (!resourceContainer.Resources.TryGetValue(name, out string value) || string.IsNullOrWhiteSpace(value))
        ...
        private ResourceContainer GetResourceContainerAndConfigureCache(ICacheEntry cacheEntry)
        {
            ...
            if (File.Exists(baseResourcePath))
            {
                ...
                baseResource = JsonConvert.DeserializeObject<Dictionary<string, string>>(baseContent);
            }
            ...
            if (File.Exists(cultureResourcePath))
            {
                ...
                cultureResource = JsonConvert.DeserializeObject<Dictionary<string, string>>(cultureContent);
            }
