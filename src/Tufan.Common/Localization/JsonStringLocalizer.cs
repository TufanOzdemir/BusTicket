...
namespace Tufan.Common.Localization
{
    public class JsonStringLocalizer<TResource> : LocalizerBase<TResource>, IStringLocalizer<TResource>
    {
        ...
        public JsonStringLocalizer(IMemoryCache memoryCache,
            ...
            IWebHostEnvironment hostingEnvironment) : base(memoryCache, options, hostingEnvironment)
        {
    ...
    {
        public JsonStringLocalizer(IMemoryCache memoryCache, IOptions<LocalizationOptions> options, IWebHostEnvironment hostingEnvironment) : base(memoryCache, options, hostingEnvironment)
        {
        }
    }
}