...
namespace Tufan.Common.Logging
{
    public class NLogService : ILogService
    {
        ...
        public void Debug(string message, System.Exception ex, params string[] listeners)
        {
            foreach (string listener in listeners)
            {
                try
        ...
        public void Info(string message, System.Exception ex, params string[] listeners)
        {
            foreach (string listener in listeners)
            {
                try
        ...
        public void Warn(string message, System.Exception ex, params string[] listeners)
        {
            foreach (string listener in listeners)
            {
                try
        ...
        public void Error(string message, System.Exception ex, params string[] listeners)
        {
            foreach (string listener in listeners)
            {
                try
        ...
        public void Fatal(string message, System.Exception ex, params string[] listeners)
        {
            foreach (string listener in listeners)
            {
                try
